...
// src/.umi-production/api/projects/[id]/members.ts
var members_exports = {};
__export(members_exports, {
  default: () => members_default2
});
...
// src/api/projects/[id]/members.ts
async function members_default(req, res) {
  const { id } = req.params;
  ...
  switch (req.method) {
    case "GET":
      try {
        const members = await prisma_default.projectMember.findMany({
          where: { projectId },
          include: {
            user: {
    ...
    case "POST":
      try {
        ...
        const member = await prisma_default.projectMember.create({
          data: {
    ...
    case "DELETE":
      try {
        ...
        await prisma_default.projectMember.delete({
          where: {
            userId_projectId: {
              userId: parseInt(userId, 10),
              projectId
...
var members_default2 = async (req, res) => {
  ...
  await members_default(umiReq, umiRes);
};
