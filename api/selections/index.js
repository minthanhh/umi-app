...
// src/.umi-production/api/selections/index.ts
var selections_exports = {};
__export(selections_exports, {
  default: () => selections_default
});
module.exports = __toCommonJS(selections_exports);
  ...
  try {
    switch (method) {
      case "GET": {
        ...
        const saved = await prisma_default.savedFilter.findFirst({
          where: {
            page,
            isDefault: true
          }
      ...
      case "POST": {
        ...
        const saved = await prisma_default.savedFilter.upsert({
          where: {
            name_page: {
              name: "default",
              page
...
var selections_default = async (req, res) => {
